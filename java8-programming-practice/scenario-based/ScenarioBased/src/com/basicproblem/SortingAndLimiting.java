...
public class SortingAndLimiting {
	public static void main(String[] args) {
		...
		System.out.println("-------------------------------------->");
		System.out.println(students.stream().sorted((a,b) -> b.rank - a.rank).map(x -> x.name).collect(Collectors.toList()));

		// Print top 5 students based on rank.
		System.out.println("-------------------------------------->");
		System.out.println(students.stream().sorted((a,b) -> a.rank - b.rank).map(x -> x.name).limit(5).collect(Collectors.toList()));


		// Print last 3 students based on rank.
		System.out.println("-------------------------------------->");
		System.out.println(students.stream().sorted((a,b) -> b.rank - a.rank).map(x -> x.name).limit(3).collect(Collectors.toList()));
