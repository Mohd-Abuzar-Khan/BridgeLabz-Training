...
public class SmartParkingLot {
    ...
    public static void main(String[] args) {
		...
		//Details regarding Parking lots
		int totalSpots = 20;
		int vacantSpots = 20;
		int occupiedSpots = 0;
			...
			switch(choice){
				...
				case 1 : {
					...
					if (occupiedSpots == totalSpots){
						...
						System.out.println("Congratulations! Your car in succesfully parked at Slot no. : " + (occupiedSpots + 1));
						occupiedSpots++;
						vacantSpots--;
				...
				case 2: {
					...
					System.out.println("-------------------------");
					System.out.println("Total Number of Parking Spots :" + totalSpots);
					System.out.println("Number of Occupied Spots are :" + occupiedSpots);
					System.out.println("Number of Vacant Spots are :" + vacantSpots);
					break;
				}
